...
class TrainPipeline:
    ...
    def start_data_ingestion(self)->DataIngestionArtifact:
        try:
            logging.info("Enterd the start_data_ingestion method of Training Pipeline class")
            ...
            return AppExecption(e,sys)
        

        
    def start_data_validation(self,data_ingestion_artifact:DataIngestionArtifact)->DataValidationArtifact:
        logging.info("Enterd the star_data_validation method of TrainPipeline class")
        ...
        try:
            ...
            raise AppExecption(e,sys) from e
